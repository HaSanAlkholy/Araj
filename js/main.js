$(window).on("load", function () {
  ...
  $("#video-player").click(function (e) {
    $("#s-video").toggleClass("s-video-active");
    $("#s-video iframe").attr("src", $("#s-video iframe").attr("data-src"));
    $("html").toggleClass("overflow");
  });

  $("#s-video").click(function (e) {
    if (e.target.id == "s-video") {
      $(this).removeClass("s-video-active");
